...
gdf['ptr_wkt'] = gdf.centroid.buffer(100)
...
# figure
gdf2['col'] = gdf2.index
gdf_data2 = gdf2[['sgg_cd', 'sgg_nm','col']].copy()

# help
#https://plotly.github.io/plotly.py-docs/generated/plotly.express.choropleth_mapbox.html
fig = px.choropleth_mapbox(gdf_data2, geojson=j_file, locations='sgg_cd', color='col',
                           color_continuous_scale="Viridis",
                           mapbox_style="carto-positron",
                           zoom=7, center = {"lat": 37.5, "lon": 126.5},
                           opacity=0.5,
                           hover_name = 'sgg_nm'
                          )
fig.show()
